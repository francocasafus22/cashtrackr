...
export default function ConfirmPasswordForm() {
    ...
    const [state, dispatch, isPending] = useActionState(deleteBudgetWithPassword, {
        errors: [],
        success: ""
    })
    ...
    return (
        ...
        <DialogTitle
            as="h3"
            className="font-black text-4xl text-purple-950 mt-5"
        >
        ...
        >
            ...
            <label
                ...
                htmlFor="password"
            >Ingresa tu Password para eliminar <span className="text-amber-500">eliminar el presupuesto {''}</span></label>
            <input
                id="password"
                type="password"
            ...
            >{isPending ? <Spinner color="text-amber-500"/> : 'Eliminar Presupuesto'}</button>
            <button
